    ...
    <div className="Leisure__container">
      ...
      <div>
        ...
        <div className="leisure__text">
          <h3>PREBODA Viernes 15 Sep. 19:00h.</h3>
          <h4>WHITE PARTY · Café del Cabo</h4>
          <a
            href="https://www.google.com/maps/place/36%C2%B049'12.6%22N+2%C2%B003'04.5%22W/@36.820179,-2.051257,17z/data=!3m1!4b1!4m4!3m3!8m2!3d36.820179!4d-2.051257?entry=ttu"
            target="_blank"
            rel="noreferrer"
      ...
      <div>
        ...
        <div className="leisure__text">
          ...
          <a
            href="https://www.google.com/maps/place/36%C2%B045'22.6%22N+2%C2%B007'18.1%22W/@36.756278,-2.12169,17z/data=!3m1!4b1!4m4!3m3!8m2!3d36.756278!4d-2.12169?entry=ttu"
            target="_blank"
            rel="noreferrer"
            className="leisure__text-link"
          >
      ...
      <div>
        ...
        <div className="leisure__text">
          ...
          <p>
            <a className="phone" href="tel:+34678499972">
              (+34) 678 49 99 72
            </a>
          </p>
        </div>
      ...
      <div>
        ...
        <div className="leisure__text">
          ...
          <p>
            <a className="phone" href="tel:950611175">
              950 61 11 75
            </a>
          </p>
        </div>
